...
export default function GestionarTutores() {
          ...
          >
            <View>
              ...
              <View style={styles.box}>
                <Text style={styles.title}>Listado de Tutores</Text>
                <Text style={styles.baseText}>Desde esta sección podrá gestionar los tutores de los alumnos.</Text>
              </View>
              ...
              <View>
                <ScrollView>
                  <View style={styles.grayBackground}>
                    <TouchableOpacity style={styles.boxAñadir} onPress={() => navigation.navigate('AddTutor')}>
                      <Text style={styles.textAlumnName}>Añadir un tutor</Text>
                    </TouchableOpacity>               
                  </View>
                </ScrollView>
              </View>
